...
const DEFAULT_STORES = [
  ...
  },
  {
    ...
    name: 'All in the Van',
    category: 'Travel & Tour',
    description: 'All in the Van Travel & Tour',
...
function getMessengerUrl(profileUrl, productName = '') {
  try {
    const url = new URL(profileUrl);
    const isFacebookProfile = /(^|\.)facebook\.com$/i.test(url.hostname);
    const profileName = url.pathname.split('/').filter(Boolean)[0];
  ...
  container.innerHTML = `
    <div class="pdp-main">
      ...
      <div class="pdp-details">
        ...
        ${product.storeUrl ? `<p class="pdp-reservation"><a href="${escapeHTML(getMessengerUrl(product.storeUrl, product.name))}" target="_blank" rel="noopener noreferrer"><svg class="pdp-reservation-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M14 8h3V4h-3c-3.3 0-5 1.9-5 5v3H6v4h3v8h4v-8h3l1-4h-4V9c0-.7.3-1 1-1Z"/></svg>DM us to reserve yours today!</a></p>` : ''}
        <aside class="shopee-side-promo-carousel pdp-shopee-carousel" data-carousel="shopee-promos" aria-label="Shopee campaigns">
          <div class="shopee-side-promo-slides">
            <div class="shopee-side-promo">
              <a class="shopee-promo-image" href="https://s.shopee.ph/7VGGFiWtt7" target="_blank" rel="sponsored noopener noreferrer">
            ...
            <div class="shopee-side-promo">
              <a class="shopee-promo-image" href="https://s.shopee.ph/4AzoHelY7G" target="_blank" rel="sponsored noopener noreferrer">
            ...
            <div class="shopee-side-promo">
              <a class="shopee-promo-image" href="https://s.shopee.ph/2gB0Uv633Z" target="_blank" rel="sponsored noopener noreferrer">
        ...
        <div class="shopee-side-promo-carousel shopee-side-product-slides" data-carousel="shopee-products" aria-label="Shopee product deals">
          <div class="shopee-side-promo-slides">
            <div class="shopee-side-promo"><a class="shopee-promo-image" href="https://s.shopee.ph/1gITJ6MEog" target="_blank" rel="sponsored noopener noreferrer"><img src="https://cf.shopee.sg/file/2e9bfe13ce9cecfbfad8010b843651f6" alt="Shopee product deal banner 1"></a></div>
            <div class="shopee-side-promo"><a class="shopee-promo-image" href="https://s.shopee.ph/7pt6eS1FI8" target="_blank" rel="sponsored noopener noreferrer"><img src="https://cf.shopee.sg/file/372cf1ccdb799772760d819408df35ba" alt="Shopee product deal banner 2"></a></div>
            <div class="shopee-side-promo"><a class="shopee-promo-image" href="https://s.shopee.ph/112mVuW0kz" target="_blank" rel="sponsored noopener noreferrer"><img src="https://cf.shopee.sg/file/a3db43790bd5a473e606076fa4bc6717" alt="Shopee product deal banner 3"></a></div>
            <div class="shopee-side-promo"><a class="shopee-promo-image" href="https://s.shopee.ph/3LQhIDDmtU" target="_blank" rel="sponsored noopener noreferrer"><img src="https://cf.shopee.sg/file/f88a53eadc71460a50ba49316235a5a5" alt="Shopee product deal banner 4"></a></div>
          </div>
